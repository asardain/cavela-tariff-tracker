    ...
    rows.on('mouseenter', function(event, d) {
      ...
      tooltipTimeout = setTimeout(() => {
        ...
        const effectiveLine = d.effective_date
          ? `<div style="margin-top:4px;color:#555;font-size:12px">Effective date: ${d.effective_date}</div>`
          : '';
        tooltip
          .style('display', 'block')
          ...
          .html(`
            ...
            <div style="margin-top:4px;color:#555;font-size:12px">Published: ${publishedFormatted}</div>
            ${effectiveLine}
          `);
      }, 300);
